...
let exp2 :=  (* and, or *)
  | a=exp2; CONS; b=exp3; { BinOp (Cons, a, b) } 
  | a=exp2; AND; b=exp3; { BinOp (And, a, b) }
  | a=exp2; OR; b=exp3; { BinOp (Or, a, b) }
  | e=exp3; { e }

let exp3 :=  (* addition, subtraction *)
  | a=exp3; PLUS; b=exp4; { BinOp (Add, a, b) }
  | a=exp3; MINUS; b=exp4; { BinOp (Sub, a, b) }
  | e=exp4; { e }

let exp4 :=  (* multiplication, division *)
  | a=exp4; TIMES; b=exp5; { BinOp (Mul, a, b) }
  | a=exp4; DIV; b=exp5; { BinOp (Div, a, b) }
  | e=exp5; { e }

let exp5 :=
  | MINUS; e=exp5; %prec UMINUS { UnOp (Neg, e) }  (* unary minus *)
  | NOT; e=exp5; %prec NOT    { UnOp (Not, e) }
  | e=exp6; { e }
